...
class TicketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($ticketFind->ticket_type_id == 7) {
            ...
            $customerSMS = "Thank you for placing order. Your Order ID is " . $ticketFind->id . ", please call 16556 for further query or support. Online Payment Link: https://igloobd.com/test/?i=".$encodedID;
            ...
            // me
            // $curl = curl_init();
            // curl_setopt($curl, CURLOPT_URL, "https://smsplus.sslwireless.com/api/v3/send-sms?api_token=3768cecd-b47d-4358-9e64-395288340fa9&sid=IGLOO&sms=".urlencode($customerSMS)."&msisdn=01873051953&csms_id=123456789");
